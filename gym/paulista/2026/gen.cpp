...
uniform_int_distribution<int> chares('a', 'z');
uniform_int_distribution<int> pq(1, 5);
uniform_int_distribution<int> nm(1, 10);
...
signed main(){
    ...
    int tsize = pq(rng);
    while (tsize > s.size()) tsize = pq(rng);
    string tt = s.substr(0, tsize);
